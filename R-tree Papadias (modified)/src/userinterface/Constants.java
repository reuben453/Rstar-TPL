...
/* These values are now set by the users - see UserInterface module.*/
    ...
    public final static float MAXFLOAT=(float) 3.4028235E+38;
    public final static int NUM_TRIES=10;

    
    /**
     * clone the RTDataNode object that is passed
      
     
    public RTDataNode Clone1(RTDataNode a, int i)
    {
    	Object b =new Object();
    	RTDataNode temp;
    	a.clone();
    ...
    /*
     * taken from http://www.java-gaming.org/index.php?topic=22590.0 posted by "CommanderKeith"
     */
    ...
    */
    ...
    public static float MINDIST(PPoint point, float bounces[])
    {
        //
