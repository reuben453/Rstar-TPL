...
public class NewMain_clipping_Test extends Canvas {
    ...
    public static void main(String[] args) {
    	...
    	TreeCreation tc = new TreeCreation("ab.rtr",3, 3,256,128);
    	...
    	Data d = new Data();
    	d.data[0]=d.data[1]=100;
    	d.data[2]=d.data[3]=100;
    	d.data[4]=d.data[5]=50;
    	
    	//d.data[0]=d.data[1]=d.data[2]=d.data[3]=200;
    	cur_node.data[0]=d;
    	Data d1 = new Data();
    	d1.data[0]=d1.data[1]=300;
    	d1.data[2]=d1.data[3]=300;
    	d1.data[4]=d1.data[5]=100;
    	cur_node.data[1]=d1;
    	
    	Data d2 = new Data();
    	d2.data[0] = d2.data[1] = 100;
    	d2.data[2] = d2.data[3] = 200;
    	d2.data[4]=d2.data[5]=50;
    	cur_node.data[2]=d2;
    	//cur_node.data[2] = d2;
    	//cur_node.data[0].
    	//cur_node.data[0].
    	...
    	*/
    	RTDataNode one = new RTDataNode(tc.rt, cur_node, 2);
        ...
        three.data[0] = d3;*/
    	TPL_algorithm.cand_set.add(one);
    	//a.cand_set.add(two);
